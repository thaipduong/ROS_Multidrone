...
message(STATUS "drone: 5 messages, 0 services")

set(MSG_I_FLAGS "-Idrone:/home/mvp/Desktop/testnavi/src/drone/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mvp/Desktop/testnavi/src/drone/msg/GasSensorData.msg" NAME_WE)
add_custom_target(_drone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone" "/home/mvp/Desktop/testnavi/src/drone/msg/GasSensorData.msg" ""
)

get_filename_component(_filename "/home/mvp/Desktop/testnavi/src/drone/msg/GridTx.msg" NAME_WE)
add_custom_target(_drone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone" "/home/mvp/Desktop/testnavi/src/drone/msg/GridTx.msg" ""
)

get_filename_component(_filename "/home/mvp/Desktop/testnavi/src/drone/msg/NavSatFix.msg" NAME_WE)
add_custom_target(_drone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone" "/home/mvp/Desktop/testnavi/src/drone/msg/NavSatFix.msg" ""
)

get_filename_component(_filename "/home/mvp/Desktop/testnavi/src/drone/msg/DroneComm.msg" NAME_WE)
add_custom_target(_drone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone" "/home/mvp/Desktop/testnavi/src/drone/msg/DroneComm.msg" ""
)

get_filename_component(_filename "/home/mvp/Desktop/testnavi/src/drone/msg/Num.msg" NAME_WE)
add_custom_target(_drone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone" "/home/mvp/Desktop/testnavi/src/drone/msg/Num.msg" ""
)
...
_generate_msg_cpp(drone
  "/home/mvp/Desktop/testnavi/src/drone/msg/GridTx.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/drone
)
_generate_msg_cpp(drone
  "/home/mvp/Desktop/testnavi/src/drone/msg/DroneComm.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/drone
)
_generate_msg_cpp(drone
  "/home/mvp/Desktop/testnavi/src/drone/msg/NavSatFix.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/drone
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone\")")
  # install generated code
  install(
